...
El contenido editable vive principalmente en `src/App.tsx`. Navegación: `NAV_LINKS`. Tratamientos: `TREATMENTS`. Beneficios: `BENEFITS`. Testimonios: `TESTIMONIALS`. Perfiles, datos de contacto y avisos están en sus secciones.
