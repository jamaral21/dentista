...
- [ ] Confirmar restauración de foco del modal con una auditoría manual.
...
No se marcan como ejecutadas las validaciones que requieren un navegador automatizado o revisión humana.
